...
# training_images = 'resized_images/20180714_70x105/*.jpg'
training_images = 'resized_images/20180714_70x70/*.jpg'
# training_images = sys.argv[1]
generated_images_path = '/Users/berry/berry/python/exercise_git/keras/generated_images/20180714_ISSEY_MIYAKE_femme/'
# generated_images_path = sys.argv[2]
...
def discriminator_model():
    ...
    model.add(Conv2D(256, (5, 5),
                     ...
                     # input_shape=(100, 150, 3))) # ここ注意
                     # input_shape=(70, 105, 3))) # ここ注意
                     # input_shape=(105, 70, 3))) # ここ注意
                     input_shape=(70, 70, 3))) # ここ注意
...
# NUM_EPOCH = 30000
NUM_EPOCH = 10
# GENERATED_IMAGE_PATH = 'generated_images/20180714_ISSEY_MIYAKE_femme/' # 生成画像の保存先
GENERATED_IMAGE_PATH = generated_images_path # 生成画像の保存先


def train():

    # files = glob.glob('resized_images/20180714_100x150/*.jpg') #訓練画像ディレクトリ
    files = glob.glob(training_images) #訓練画像ディレクトリ
    # print(files)
    images = []
    for f in files:
        img = Image.open(f)
