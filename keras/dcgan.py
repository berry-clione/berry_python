...
root_dir = "/home/takasugi/gan/ISSEY_MIYAKE/"
input_img_dir = "resized_images_20180810_688x1024"
save_dir = "generated_images/20180810_ISSEY_MIYAKE_femme/"
class DCGAN():
    def __init__(self):
    ...
    def build_generator(self):
        ...
        model.add(Dense(1024 * 43 * 64, activation="relu", input_shape=noise_shape))
        # model.add(Reshape((32, 32, 128)))
        model.add(Reshape((64, 43, 1024)))
    ...
    def train(self, iterations, batch_size=128, save_interval=50, model_interval=10000, check_noise=None, r=5, c=5):
        ...
        for iteration in range(iterations):
            ...
            # print("----------------------")
            # print(noise.shape)
            # print(gen_imgs.shape) ### (16, 128, 128, 3)
            # print(np.zeros((half_batch, 1)))
    ...
    def save_imgs(self, iteration, check_noise, r, c):
        ...
        for i in range(r):
            for j in range(c):
                ...
                # plt.axis('off')
                cnt += 1
                # plt.savefig(save_dir + str(cnt) +'%d.png' % iteration)
    ...
    def visualizeInterpolation(self, start, end, save=True, nbSteps=4):
